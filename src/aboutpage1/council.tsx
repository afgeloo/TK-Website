...
function Council() {
    ...
    useEffect(() => {
        ...
        fetch("http://172.20.10.2/tara-kabataan/tara-kabataan-backend/api/council.php")
            .then(res => res.json())
                        ...
                        <div key={index} className="council-card council-card-main">
                            <div className="council-inner-card-1-president">
                                <div className="council-inner-card-2">
                                    ...
                                    <img
                                    src={`http://172.20.10.2/tara-kabataan/tara-kabataan-webapp/uploads/members-images/member-2025-000001.jpg?t=${Date.now()}`}
                                    onError={(e) => {
                                        const basePath = "http://172.20.10.2/tara-kabataan/tara-kabataan-webapp/uploads/members-images/";
                    ...
                    .map((member, index) => (
                        <div key={index} className="council-card">
                            <div className="council-inner-card-1-members">
                                ...
                                <div className="council-member-image">
                                <img
                                src={`http://172.20.10.2/tara-kabataan/tara-kabataan-webapp/uploads/members-images/${member.member_id}.jpg`}
                                onError={(e) => {
                                    const basePath = "http://172.20.10.2/tara-kabataan/tara-kabataan-webapp/uploads/members-images/";
                                    const fallbackExtensions = ["png", "jpeg"];
                                    const attemptedSrcs = fallbackExtensions.map(
