...
const AdminEvents = () => {
  ...
  useEffect(() => {
    fetch("http://172.20.10.2/tara-kabataan/tara-kabataan-backend/api/events1.php")
      .then((res) => res.json())
      .then((data) => {
        ...
        const updatedEvents = (data.events || []).map((event: Event) => {
          ...
          if (event.event_status === "UPCOMING") {
            if (now >= eventStartDatetime && now <= eventEndDatetime) {
              ...
              fetch("http://172.20.10.2/tara-kabataan/tara-kabataan-backend/api/update_event_status.php", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
  ...
  const handleSave = () => {
    ...
    fetch("http://172.20.10.2/tara-kabataan/tara-kabataan-backend/api/update_event.php", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  const handleAddNewEventSave = async () => {
    ...
    try {
      const res = await fetch("http://172.20.10.2/tara-kabataan/tara-kabataan-backend/api/add_new_event.php", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const confirmSingleDelete = async () => {
    ...
    try {
      const res = await fetch("http://172.20.10.2/tara-kabataan/tara-kabataan-backend/api/delete_event.php", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      const res = await fetch("http://172.20.10.2/tara-kabataan/tara-kabataan-backend/api/upload_event_image.php", {
        method: "POST",
        body: formData,
      });
  ...
  const handleBulkDelete = async () => {
    try {
      const response = await fetch("http://172.20.10.2/tara-kabataan/tara-kabataan-backend/api/delete_bulk_events.php", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const applyBulkStatus = async (newStatus: string) => {
    try {
      const response = await fetch("http://172.20.10.2/tara-kabataan/tara-kabataan-backend/api/update_bulk_event_status.php", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
                        ...
                        <input
                          ...
                          onChange={async (e) => {
                            ...
                            try {
                              ...
                              const data = await res.json();
                              if (data.success && data.image_url) {
                                const img = `<img src="http://172.20.10.2${data.image_url}" alt="event image" style="max-width:100%; margin: 10px 0; display:block;" />`;
                    ...
                    <div className="admin-new-event-inner-content-modal-image">
                      ...
                      <input
                        ...
                        onChange={async (e) => {
                          ...
                          const res = await fetch("http://172.20.10.2/tara-kabataan/tara-kabataan-backend/api/add_new_event_image.php", {
                            method: "POST",
                            body: formData,
                          });
